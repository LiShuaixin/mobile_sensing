...
ProjectionParams::ProjectionParams ( const int lidar_type ) : lidar_type_(lidar_type)
{
	...
	case 0:
	{
	    this->set_span(SpanParams(-180.0, 180.0, 870), SpanParams::Direction::HORIZONTAL); // default depth image size is 16 * 870
	...
	case 1:
	{
	    this->set_span(SpanParams(-180.0, 180.0, 870), SpanParams::Direction::HORIZONTAL);
	    this->set_span(SpanParams(10.0, -30.0, 32), SpanParams::Direction::VERTICAL);
	    this->fill_cossin();
	...
	case 2:
	{
	    ...
	    SpanParams span_top(2.0, -8.5, 32);
	    SpanParams span_bottom(-8.87, -24.87, 32);
	...
	{
	    this->set_span(SpanParams(-180.0, 180.0, 870), SpanParams::Direction::HORIZONTAL);
	    this->set_span(SpanParams(2.0, -24.0, 64), SpanParams::Direction::VERTICAL);
	    this->fill_cossin();
